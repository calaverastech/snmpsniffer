...
// Modified 2014 Tanya Moskun <admin@calaverastech.com>
...
Stream.prototype.parseOctetString = function (start, end) {
    if (this.isASCII(start, end))
        return this.parseStringISO(start, end);
    var len = end - start,
//        s = "(" + len + " byte)\n";
    s = "";
...
ASN1.prototype.typeName = function () {
    ...
    case 1:
    	switch (this.tag.tagNumber) {
    	case 0x00: return "IpAddress";
    	case 0x01: return "Counter32";
    	case 0x02: return "Gauge32";
    	case 0x03: return "TimeTicks";
    	case 0x04: return "Opaque";
    	case 0x05: return "NsapAddress";
    	case 0x06: return "Counter64";
...
function ASN1Tag(stream) {
    ...
    switch(buf) {
    	case 0xA0: this.command = "Get";break;
    	case 0xA1: this.command = "GetNext";break;
    	case 0xA2: this.command = "Response";break;
    	case 0xA3: this.command = "Set";break;
    	case 0xA4: this.command = "Trap";break;
    	case 0xA5: this.command = "GetBulk";break;
